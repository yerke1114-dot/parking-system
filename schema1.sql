...
\restrict UyD55bCPNvbhtrVUzy5zfRMx746gLdQuUSkMXDpw31tqBu0iSwsACZJ7Boj9emA

-- Dumped from database version 18.1
-- Dumped by pg_dump version 18.1

-- Started on 2026-01-23 19:08:01
...
-- Name: rental_plans; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.rental_plans OWNER TO postgres;

--
-- TOC entry 226 (class 1259 OID 16472)
-- Name: rental_plans_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.rental_plans_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.rental_plans_id_seq OWNER TO postgres;

--
-- TOC entry 5059 (class 0 OID 0)
-- Dependencies: 226
-- Name: rental_plans_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.rental_plans_id_seq OWNED BY public.rental_plans.id;
...
--
-- TOC entry 4876 (class 2604 OID 16446)
...
--
-- TOC entry 4877 (class 2604 OID 16447)
...
--
-- TOC entry 4874 (class 2604 OID 16413)
...
--
-- TOC entry 4879 (class 2604 OID 16476)
-- Name: rental_plans id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.rental_plans ALTER COLUMN id SET DEFAULT nextval('public.rental_plans_id_seq'::regclass);


--
-- TOC entry 4872 (class 2604 OID 16403)
...
--
-- TOC entry 5048 (class 0 OID 16443)
-- Dependencies: 225
-- Data for Name: parking_orders; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.parking_orders (id, "User_ID", spot_number, owner_phone, car_number, status, start_date, end_date, plan_id) FROM stdin;
2	1	100	87777777777	111AAA11	ACTIVE	2026-01-23 17:35:25.84057+05	\N	\N
3	1	67	81111111111	000SSS01	ACTIVE	2026-01-23 17:35:25.84057+05	\N	\N
4	1	56	87777777777	777GGG77	ACTIVE	2026-01-23 18:52:10.478616+05	\N	\N
\.


--
-- TOC entry 5045 (class 0 OID 16410)
-- Dependencies: 222
...
--
-- TOC entry 5050 (class 0 OID 16473)
-- Dependencies: 227
-- Data for Name: rental_plans; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.rental_plans (id, months, price) FROM stdin;
1	1	200
2	3	550
3	6	1000
\.
...
SELECT pg_catalog.setval('public.parking_orders_id_seq', 4, true);
...
-- Dependencies: 226
-- Name: rental_plans_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.rental_plans_id_seq', 3, true);
...
-- Completed on 2026-01-23 19:08:01

--
-- PostgreSQL database dump complete
--

\unrestrict UyD55bCPNvbhtrVUzy5zfRMx746gLdQuUSkMXDpw31tqBu0iSwsACZJ7Boj9emA
